...
namespace CustomChaosPool
{
    ...
    public class CustomChaosPool : BaseUnityPlugin
    {
        ...
        private void ConfigInit()
        {
            ...
            TricornPatch = Config.Bind("Experimental", "Trophy Hunter's Tricorn patch", false, "Enables a patch to stop your equipment from getting cosumed if trophy hunter's tricorn is in the bottled chaos pool\nmight break mods that alter tricorn\n(requires Experimental)");
